...
jest.dontMock('../../../../src/model/promotion/discount/brand-discount');
...
describe('BrandDiscount', function() {
    ...
    beforeEach(function() {
        ...
        BrandDiscount = require('../../../../src/model/promotion/discount/brand-discount');
        ...
        brand = new BrandDiscount(0.9, cartItems, '可口可乐');
    });
